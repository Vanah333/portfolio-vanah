...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Safidy Sylvana Nambinjanahary — AI & Software Engineer" },
      { name: "description", content: "Portfolio of Safidy Sylvana Nambinjanahary, Computer Science graduate and Master's student in Artificial Intelligence from Madagascar. AI, Full-Stack, Cybersecurity & IoT." },
      { name: "author", content: "Safidy Sylvana Nambinjanahary" },
      { name: "theme-color", content: "#0EA5E9" },
      { property: "og:title", content: "Safidy Sylvana Nambinjanahary — AI & Software Engineer" },
      { property: "og:description", content: "AI, Full-Stack Development, Cybersecurity & IoT — from Madagascar." },
